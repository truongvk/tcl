...
Ext.onReady(function(){
    ...
    var getnodesUrl = '<?php echo $this->Html->url('/admin/properties/getnodes');?>';
    var reorderUrl = '<?php echo $this->Html->url('/admin/properties/reorder/') ?>';
    var reparentUrl = '<?php echo $this->Html->url('/admin/properties/reparent/') ?>';
