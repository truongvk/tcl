<div class="groups">
	<table cellpadding="0" cellspacing="0" id="table-groups" class="table table-striped table-bordered table-condensed">
	<thead>
	<tr>
	...
	<tr id='<?php echo $group['Group']['id'];?>'>
		<td><?php echo h($group['Group']['id']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['name']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['created']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['modified']); ?>&nbsp;</td>
		<td style="text-align: center">
			<span class="label label-info link-white"><i class="icon-zoom-in icon-white"></i> <?php echo $this->Html->link(__('View'), array('action' => 'view', $group['Group']['id'])); ?></span>
